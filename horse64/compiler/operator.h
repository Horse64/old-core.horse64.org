...
static int operator_PrecedenceByType(int type) {
    ...
    case H64OP_MATH_DIVIDE: return 2;
    case H64OP_MATH_MULTIPLY: return 2;
    case H64OP_MATH_MODULO: return 2;
    case H64OP_MATH_ADD: return 3;
    case H64OP_MATH_SUBSTRACT: return 3;
    case H64OP_MATH_BINSHIFTLEFT: return 4;
    case H64OP_MATH_BINSHIFTRIGHT: return 4;
    case H64OP_CMP_EQUAL: return 5;
    case H64OP_CMP_NOTEQUAL: return 5;
    case H64OP_CMP_LARGEROREQUAL: return 5;
    case H64OP_CMP_SMALLEROREQUAL: return 5;
    case H64OP_CMP_LARGER: return 5;
    case H64OP_CMP_SMALLER: return 5;
    case H64OP_BOOLCOND_IN: return 6;
    case H64OP_BOOLCOND_NOT: return 7;
    case H64OP_BOOLCOND_AND: return 8;
    case H64OP_BOOLCOND_OR: return 9;
    }
    return -1;
}
